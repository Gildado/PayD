...
export const ReportExecutionZod = z.object({
  ...
  rowCount: z.number().non_negative().optional(),
...
export const ReportResultZod = z.object({
  ...
  summary: z.object({
    totalRecords: z.number().non_negative(),
    processedRecords: z.number().non_negative(),
    failedRecords: z.number().non_negative(),
    generatedAt: z.date(),
...
export const DeliveryConfigZod = z.object({
  ...
  retryPolicy: z.object({
    maxRetries: z.number().non_negative().default(3),
