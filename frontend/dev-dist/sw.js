...
define(['./workbox-0791036e'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    url,
    sameOrigin
  }) => sameOrigin && url.pathname.startsWith("/api/v1/audit"), new workbox.StaleWhileRevalidate({
  ...
  workbox.registerRoute(({
    url,
    sameOrigin
  }) => sameOrigin && url.pathname.startsWith("/api/events/"), new workbox.StaleWhileRevalidate({
